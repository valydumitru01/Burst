...
impl RasterizationStage {
    ...
    pub fn build_rasterization_state(&self) -> vk::PipelineRasterizationStateCreateInfo {
        ...
        let rasterizer_discard_enable = false;
        ...
        debug!(
            "Created PipelineRasterizationStateCreateInfo struct: {:#?}",
            &rasterization_state
        );
    ...
    pub fn build_multisample_state(&self) -> vk::PipelineMultisampleStateCreateInfo {
        ...
        let multisample_state = vk::PipelineMultisampleStateCreateInfo::builder()
            ...
            .build();
        debug!(
            "Created PipelineMultisampleStateCreateInfo struct: {:#?}",
            &multisample_state
        );
