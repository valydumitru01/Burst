...
enum_impl! {
    ...
    pub enum InstanceLayer {
        ...
        Validation = LayerStr::from_bytes("VK_LAYER_KHRONOS_validation".as_bytes()),
        ...
        ApiDump = LayerStr::from_bytes("VK_LAYER_LUNARG_api_dump".as_bytes()),
        ...
        RenderDoc = LayerStr::from_bytes("VK_LAYER_RENDERDOC_Capture".as_bytes()),

        LunargGfxReconstruct = LayerStr::from_bytes("VK_LAYER_LUNARG_gfxreconstruct".as_bytes()),

        KhronosSynchronization2 = LayerStr::from_bytes("VK_LAYER_KHRONOS_synchronization2".as_bytes()),

        LunargMonitor = LayerStr::from_bytes("VK_LAYER_LUNARG_monitor".as_bytes()),

        LunargScreenshot = LayerStr::from_bytes("VK_LAYER_LUNARG_screenshot".as_bytes()),

        KhronosProfiles = LayerStr::from_bytes("VK_LAYER_KHRONOS_profiles".as_bytes()),
